...
# 前言
从 Jekyll 到 GitHub Pages 中间踩了许多坑，终于把我的个人博客[leesx Blog](http://leesx.cn)搭建出来了。。。
...
注册完成后搜索 `leesx.github.io` 进入[我的仓库](https://github.com/leesx/leesx.github.io)
...
keyword: "leesx, leesx Blog, 柏荧的博客, leesx, 邱柏荧, iOS, Apple, iPhone" #关键词
url: "https://leesx.github.io"          # 这个就是填写你的博客地址
baseurl: ""      # 这个我们不用填写
...
搭建好博客之后 你可能不想直接使用 [baiyingqiu.github.io](http://baiyingqiu.github.io) 这么长的博客域名吧, 想换成想 [leesx.cn](http://leesx.cn) 这样简短的域名。那我们开始吧！
...
用**阿里云** app也可以注册域名，域名的价格根据后缀的不同和域名的长度而分，比如我这个 `leesx.cn` 的域名第一年才只要4元~
...
一个主机记录为 `www`,代表可以解析 `www.leesx.cn`的域名
...
若本教程顺利帮你搭建了自己的个人博客，请不要 **害羞**，给我的 [github仓库](https://github.com/leesx/leesx.github.io) 点个 **star** 吧！

因为最近发现 Fork 将近破百，加上直接 Clone 仓库的，保守估计已经帮助上百人成功的搭建了自己的博客，可是 Star 却仅仅只有 **12**！可能还是做的不够好吧！

### **别无他求，点个 [Star](https://github.com/leesx/leesx.github.io) 吧**！
