...
```
# Baidu Analytics
ba_track_id: 4cc1f2......86cc5cdb626a202900

# Google Analytics
ga_track_id: 'UA-4...1'            # 你用Google账号去注册一个就会给你一个这样的id
...
标题底图是可以自己选的，看看几篇示例post你就知道如何设置了。在
  [issue #6 ](https://github.com/Huxpro/huxpro.github.io/issues/6) 中
...
我的博客标题是 **“leesx Blog”** 但是我想要在搜索的时候显示 **“Leesx的博客 | leesx Blog”** ，这个就需要SEO Title来定义了。
